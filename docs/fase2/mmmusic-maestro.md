...
**Última actualización:** 12 de septiembre de 2026 (Fase 2 especificada; Fase 1 completada y validada)
...
| 2 | Scrobbling, Recopilatorios y Favoritas | 59 | 4 | 3-4 | Especificada |
| **Total** | | **171** | **9** | **~2,5 meses** | |
...
| 2 | 0 / 59 | ninguno — sin confirmar |

**Progreso total:** 112 / 171 funcionalidades.
...
Orden recomendado: 3 → 4 → 5 (la 2 está especificada). Idea añadida en F2: sincronizar favoritas con ListenBrainz si algún día la biblioteca lleva MBIDs (Picard).
